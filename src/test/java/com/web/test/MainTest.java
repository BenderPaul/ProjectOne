  ...
  User testUser = new User(100, "Jerry123", "theseinfield", "Jerry", "Seinfield",
  ...
  @Test public void testUserDatabaseGetUsername(){ 
	  assertEquals("Mr",testUserService.findById(1).getUsername()); 
  }
  
  @Test public void testUserDatabaseGetPassword(){ 
	  assertEquals("Manager",testUserService.findById(1).getPassword()); 
  }
  
  @Test public void testUserDatabaseGetLastName(){ 
	  assertEquals("Dad",testUserService.findById(1).getLastName()); 
  }
  
  @Test public void testUserDatabaseGetFirstName(){ 
	  assertEquals("Tom",testUserService.findById(1).getFirstName()); 
  }
  
  @Test public void testUserDatabaseGetEmail(){
  assertEquals("TheDad@gmail.com",testUserService.findById(1).getUserEmail()); 
  }
